...
<head>
    ...
    <title>Pessage | Borderless Words</title>
...
<body>
    <main id="contactPage" class="mainPagesBody">
        <div class="contactContent">
            <h1>Message</h1>
            <form action="../processors/messageProcessor.php" method="POST" class="contactForm">
                ...
                <button name="submit" id="submitContact" value="<?= $_SESSION['taid'] ?>">Submit</button>
