...
$stmt = $pdo->query("SELECT * FROM accounts a INNER JOIN profile p ON a.aid = p.aid INNER JOIN accountType act ON act.aid = p.aid WHERE aType = 'personal'");
$stmt->execute();
...
<head>
	...
	<title>Personal Client List | Borderless Words</title>
