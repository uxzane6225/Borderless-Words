...
$stmt = $pdo->query("SELECT * FROM accounts a INNER JOIN profile p ON a.aid = p.aid INNER JOIN accountType att ON att.aid = p.aid WHERE aType = 'freelance'");
$stmt->execute();
...
<head>
	...
	<title>Freelance Translator List | Borderless Words</title>
	...
	<main class="dashboardMain">
		<section class="mainContentContainer">
			<header class="mainContentHeader">
				<h2>Freelance Translator List</h2>
