...
$stmt = $pdo->query("SELECT * FROM accounts a INNER JOIN profile p ON a.aid = p.aid INNER JOIN accountType act ON act.aid = p.aid WHERE aType = 'organization'");
$stmt->execute();
...
<head>
	...
	<title>Translator Organization List | Borderless Words</title>
	...
	<main class="dashboardMain">
		<section class="mainContentContainer">
			<header class="mainContentHeader">
				<h2>Translator Organization List</h2>
